...
<html>
    <head>
        <title>GDA | Página de Inicio</title>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="menu">
                <ul>
                <li><a href="#" onclick="getPage('User/Registration.php')">Registro</a></li>
                <li><a href="#">Gestión Archivos</a>
                <ul>
                <li><a href="#" onclick="getPage('Upload/Upload.php')">Agrega Nuevo Archivo</a></li>
                ...
                <li style="margin-top: 5px;margin-left: 25em;">Has ingresado como : <?php echo $username?></li>
                
                </ul>
            </div>
            <div id="main">
            <div id="content">
            <h1>Le damos la bienvenida a su Gestor de Archivos ConfiguroWeb</h1>
            ...
            <table style="border: 1px black solid;background-color: #607B8B;">
                ...
                <tr>
                    <td><li><a href="#" onclick="getPage('View/View.php')">Ver Archivos</a></li></td>
                </tr>
                <tr>
                    <td><li><a href="#" onclick="getPage('User/Registration.php')">Agregar Usuario</a></li></td>
                </tr>
                <tr>
                    <td><li><a href="#" onclick="getPage('User/ViewUser.php')">Ver Usuarios</a></li></td>
                </tr>
